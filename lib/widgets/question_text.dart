...
class QuestionsText extends StatefulWidget{
  ...
  QuestionsText(this._questionNumber,this._question);

  @override 
  State createState() => new QuestionTextState();
}

class QuestionTextState extends State<QuestionsText> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(QuestionsText oldWidget){
